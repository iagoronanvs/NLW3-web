...
const CreateOrphanage: React.FC = () => {
  ...
  const [form, setForm] = useState<FormData>({ open_on_weekends: true } as FormData);
  ...
  const handleSubmit = useCallback(async (event: FormEvent) => {
    ...
    history.push('/app');
  }, [form, history, images, position]);

  useEffect(() => {
    navigator.geolocation.getCurrentPosition(loadCurrentPosition);

    async function loadCurrentPosition(position: Position) {
